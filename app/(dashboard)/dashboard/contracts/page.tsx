...
function getStatusInfo(status: ContractStatus): {
    ...
    switch (status) {
        case "DRAFT":           return { label: "Borrador",          variant: "warning" };
        case "ACTIVE":          return { label: "Activo",            variant: "success" };
        case "PENDING_PAYMENT": return { label: "Pdte. Facturación", variant: "warning" };
        case "COMPLETED":       return { label: "Completado",        variant: "success" };
        case "EXPIRED":         return { label: "Expirado",          variant: "danger"  };
                            ...
                            <div className="w-full sm:w-52">
                                <Select
                                    ...
                                    options={[
                                        ...
                                        { value: "PENDING_PAYMENT", label: "Sin Facturar"       },
                            ...
                            <table className="w-full text-left text-sm whitespace-nowrap">
                                ...
                                <tbody className="divide-y divide-[var(--color-border-subtle)]">
                                    {isLoading ? (
                                        ...
                                        <tr>
                                            <td colSpan={6} className="px-6 py-8 text-center text-[var(--color-text-tertiary)]">
                                                ...
                                                <tr key={contract.contractId} className="hover:bg-[var(--color-surface-hover)] transition-colors">
                                                    ...
                                                    <td className="px-6 py-4">
                                                        <span className="text-[10px] uppercase font-bold bg-[var(--color-primary-subtle)] text-[var(--color-primary-strong)] px-2 py-0.5 rounded-full">
                                                            {contract.contractRentalUnits.length} unidades
                                                        </span>
